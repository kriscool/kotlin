...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <#if log  == 1>
                <a class="navbar-brand js-scroll-trigger" style="color:white;" href="/login">Login</a>
            <#else>
                <a class="navbar-brand js-scroll-trigger" style="color:white;" href="/logout">Wyloguj</a>
            </#if>
